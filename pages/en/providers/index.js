...
const providerSectorCards = [
  { title: 'General Contracting, Construction & Building', eyebrow: 'Construction sector', desc: 'Contracting companies and providers for villas, extensions, majlis, residential and commercial projects.', href: '/en/providers/specialty/general-contracting', image: '/images/sector-cards/general-contracting-construction-card.webp', tags: ['Contracting', 'Construction', 'Building'] },
  { title: 'Engineering Offices, Consultancy & Design', eyebrow: 'Design sector', desc: 'Engineering offices for architectural, structural and MEP design, approvals and supervision.', href: '/en/providers/specialty/engineering-consultants', image: '/images/sector-cards/engineering-consultants-design-card.webp', tags: ['Design', 'Consultancy', 'Supervision'] },
  { title: 'Building Materials, Stores & Showrooms', eyebrow: 'Supply sector', desc: 'Building and finishing material sources, stores and suppliers connected to projects and contractors.', href: '/en/providers/specialty/building-materials', image: '/images/sector-cards/building-materials-stores-card.webp', tags: ['Materials', 'Stores', 'Supply'] },
  { title: 'Maintenance, Finishing, AC, Plumbing & Electrical', eyebrow: 'Maintenance sector', desc: 'Providers for general maintenance, finishing, AC, plumbing, electrical and repair work.', href: '/en/providers/specialty/general-maintenance', image: '/images/sector-cards/maintenance-finishing-ac-plumbing-electrical-card.webp', tags: ['Maintenance', 'Finishing', 'MEP'] },
  { title: 'Aluminium, Glass & Wood Works', eyebrow: 'Facade and carpentry sector', desc: 'Aluminium, glass, doors, wardrobes, kitchens, woodwork and related fabrication paths.', href: '/en/providers/specialty/aluminium-glass', image: '/images/sector-cards/aluminium-glass-wood-card.webp', tags: ['Aluminium', 'Glass', 'Wood'] },
  { title: 'Cleaning, Services & Equipment Rental', eyebrow: 'Operations sector', desc: 'Cleaning, post-construction cleaning, equipment rental, scaffolding and site support.', href: '/en/providers/specialty/cleaning-services', image: '/images/sector-cards/cleaning-equipment-rental-card.webp', tags: ['Cleaning', 'Equipment', 'Operations'] },
  { title: 'Factories, Supply Companies & Workshops', eyebrow: 'Manufacturing and supply sector', desc: 'Factories, workshops and supply companies serving building, finishing and custom materials.', href: '/en/providers/specialty/building-materials', image: '/images/sector-cards/factories-suppliers-workshops-card.webp', tags: ['Factories', 'Workshops', 'Supply'] }
];
...
export default function ProvidersEnglishPage() {
  return (
    <>
      <Head><title>Service Providers | Biet Al Reef</title><meta name="description" content="Browse Biet Al Reef service providers by specialty or register your business to appear inside the platform." /><meta name="robots" content="index, follow" /><link rel="canonical" href="https://bietalreef.ae/en/providers" /><link rel="alternate" hrefLang="ar-AE" href="https://bietalreef.ae/providers" /><link rel="alternate" hrefLang="en-AE" href="https://bietalreef.ae/en/providers" /></Head>
      <EnglishLayout>

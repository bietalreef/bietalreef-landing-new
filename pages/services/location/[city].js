...
const cities = {
  'al-ain': { name: 'العين', arabicName: 'خدمات البناء والتصميم في العين', description: 'منصة بيت الريف توفر أفضل خدمات البناء والتصميم والمقاولات في العين. اختر من أفضل المقاولين والمصممين المعتمدين في العين.', keywords: 'خدمات البناء العين, مقاولات العين, تصميم داخلي العين, استشارات هندسية العين', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=630&fit=crop' },
  'abu-dhabi': { name: 'أبوظبي', arabicName: 'خدمات البناء والتصميم في أبوظبي', description: 'منصة بيت الريف توفر أفضل خدمات البناء والتصميم والمقاولات في أبوظبي. اختر من أفضل المقاولين والمصممين المعتمدين في أبوظبي.', keywords: 'خدمات البناء أبوظبي, مقاولات أبوظبي, تصميم داخلي أبوظبي, استشارات هندسية أبوظبي', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=630&fit=crop' },
  dubai: { name: 'دبي', arabicName: 'خدمات البناء والتصميم في دبي', description: 'منصة بيت الريف توفر أفضل خدمات البناء والتصميم والمقاولات في دبي. اختر من أفضل المقاولين والمصممين المعتمدين في دبي.', keywords: 'خدمات البناء دبي, مقاولات دبي, تصميم داخلي دبي, استشارات هندسية دبي', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=630&fit=crop' },
  sharjah: { name: 'الشارقة', arabicName: 'خدمات البناء والتصميم في الشارقة', description: 'منصة بيت الريف توفر أفضل خدمات البناء والتصميم والمقاولات في الشارقة. اختر من أفضل المقاولين والمصممين المعتمدين في الشارقة.', keywords: 'خدمات البناء الشارقة, مقاولات الشارقة, تصميم داخلي الشارقة, استشارات هندسية الشارقة', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=630&fit=crop' },
  ajman: { name: 'عجمان', arabicName: 'خدمات البناء والتصميم في عجمان', description: 'منصة بيت الريف توفر أفضل خدمات البناء والتصميم والمقاولات في عجمان. اختر من أفضل المقاولين والمصممين المعتمدين في عجمان.', keywords: 'خدمات البناء عجمان, مقاولات عجمان, تصميم داخلي عجمان, استشارات هندسية عجمان', image: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=630&fit=crop' },
};
  ...
  return (
    <>
      <Head>
        ...
        <script type="application/ld+json">{JSON.stringify({ '@context': 'https://schema.org', '@type': 'LocalBusiness', name: `بيت الريف - ${cityData.name}`, description: cityData.description, areaServed: cityData.name, url: `https://bietalreef.ae/services/location/${city}`, image: cityData.image, telephone: '+971-XXXXXXXXX', address: { '@type': 'PostalAddress', addressLocality: cityData.name, addressCountry: 'AE' } })}</script>
      </Head>
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#f8f9fa' }}>
        ...
        <div style={{ background: 'linear-gradient(135deg, #1a5f3f 0%, #2d8659 100%)', color: 'white', padding: '60px 20px', textAlign: 'center', marginTop: '60px' }}>
          ...
          <p style={{ fontSize: '1.1rem', marginBottom: '30px', maxWidth: '600px', margin: '0 auto' }}>ابدأ من صفحة مزود الخدمة لفهم المنصة ثم انتقل إلى التطبيق من هناك فقط</p>

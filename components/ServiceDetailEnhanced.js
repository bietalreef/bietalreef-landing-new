...
export default function ServiceDetailEnhanced({ service }) {
  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-r from-primary to-primary-dark text-white py-12 md:py-16"><div className="max-w-4xl mx-auto px-4 text-center"><h2 className="text-3xl md:text-4xl font-bold mb-6">هل أنت مستعد للبدء؟</h2><p className="text-lg mb-8 opacity-90">اختر الخدمة المناسبة واحصل على مسار واضح لطلبك داخل بيت الريف</p><div className="flex flex-col sm:flex-row gap-4 justify-center"><Link href="/request-quote"><a className="px-8 py-4 rounded-full bg-white text-primary font-bold hover:bg-gray-100 transition shadow-lg">اطلب عرض سعر</a></Link><a href="https://wa.me/971567856001" className="px-8 py-4 rounded-full border-2 border-white text-white font-bold hover:bg-white hover:text-primary transition">تواصل معنا عبر WhatsApp</a></div></div></section>
    </>
  );
}

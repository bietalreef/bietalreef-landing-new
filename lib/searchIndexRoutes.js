...
const LAST_SITE_UPDATE = '2026-07-16';
...
const providers = ['arkleen', 'al-hoot-marble-granite-factory'];
...
function buildSearchIndexEntries() {
  const pairs = [
    ...
    ...providers.map((slug) => ({
      ...
      images: slug === 'arkleen'
        ? [
            '/images/providers/arkleen-premium/profile-cover.webp',
            ...
            '/images/providers/arkleen-premium/product-custom-kitchen.webp',
            '/images/providers/arkleen-premium/product-custom-kitchen-detail.webp',
            '/images/providers/arkleen-premium/product-custom-kitchen-storage.webp',
            '/images/providers/arkleen-premium/product-custom-wardrobe.webp',
            '/images/providers/arkleen-premium/product-custom-wardrobe-detail.webp',
            '/images/providers/arkleen-premium/product-custom-wardrobe-storage.webp',
            '/images/providers/arkleen-premium/product-custom-door.webp',
            '/images/providers/arkleen-premium/product-custom-door-detail.webp',
            '/images/providers/arkleen-premium/product-custom-door-opposite.webp',
          ]
        : ['/images/providers/al-hoot/cover.jpg'],
    })),
  ];

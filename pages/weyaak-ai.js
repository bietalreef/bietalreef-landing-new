...
<section className="bg-[#062F22] py-16 text-white"><div className="mx-auto max-w-4xl px-4 text-center"><h2 className="text-3xl font-black">وياك داخل منظومة أعمالك، لا بجانبها</h2><p className="mx-auto mt-4 max-w-2xl leading-8 text-white/75">ابدأ من حسابك وبياناتك ومساراتك، ثم فعّل الربط والخدمات التي تناسب احتياج شركتك.</p><a href="https://play.google.com/store/apps/details?id=ae.bietalreef.app" target="_blank" rel="noopener noreferrer" className="mt-8 inline-flex items-center gap-2 rounded-2xl bg-emerald-300 px-8 py-4 font-black text-[#062F22]">حمّل التطبيق وتحدث مع وياك <ArrowLeft className="h-5 w-5"/></a></div></section>
</main><Footer/></div></>}

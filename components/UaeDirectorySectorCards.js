...
const directorySectors = [
  ...
  { slug: 'aluminium-glass', titleAr: 'الألمنيوم والزجاج والأخشاب', titleEn: 'Aluminium, Glass & Wood Works', eyebrowAr: 'قطاع الواجهات والنجارة', eyebrowEn: 'Facade and carpentry sector', descAr: 'أعمال الألمنيوم والزجاج والأبواب والخزائن والمطابخ والأعمال الخشبية.', descEn: 'Aluminium, glass, doors, wardrobes, kitchens, woodwork and fabrication paths.', image: '/images/sector-cards/aluminium-glass-wood-card.webp', tagsAr: ['ألمنيوم', 'زجاج', 'أخشاب'], tagsEn: ['Aluminium', 'Glass', 'Wood'] },
  { slug: 'cleaning-services', titleAr: 'التنظيف والخدمات وتأجير المعدات', titleEn: 'Cleaning, Services & Equipment Rental', eyebrowAr: 'قطاع التشغيل', eyebrowEn: 'Operations sector', descAr: 'خدمات التنظيف وما بعد البناء وتأجير المعدات والسقالات ومعدات المواقع.', descEn: 'Cleaning, post-construction cleaning, equipment rental, scaffolding and site support.', image: '/images/sector-cards/cleaning-equipment-rental-card.webp', tagsAr: ['تنظيف', 'معدات', 'تشغيل'], tagsEn: ['Cleaning', 'Equipment', 'Operations'] },
  { slug: 'equipment-rental', titleAr: 'المصانع وشركات التوريد والورش', titleEn: 'Factories, Supply Companies & Workshops', eyebrowAr: 'قطاع التصنيع والتوريد', eyebrowEn: 'Manufacturing and supply sector', descAr: 'مصانع وورش وشركات توريد تخدم مشاريع البناء والتشطيب والمواد حسب الطلب.', descEn: 'Factories, workshops and supply companies for building, finishing and custom materials.', image: '/images/sector-cards/factories-suppliers-workshops-card.webp', tagsAr: ['مصانع', 'ورش', 'توريد'], tagsEn: ['Factories', 'Workshops', 'Supply'] },
];

const abuDhabiProductCards = [
  { slug: 'building-materials', marketplace: true, titleAr: 'مواد البناء والتشييد', titleEn: 'Building & Construction Materials', eyebrowAr: 'منتجات ومتاجر', eyebrowEn: 'Products & stores', descAr: 'الأسمنت والحديد والطابوق والعزل والمواد الأساسية لمشاريع البناء.', descEn: 'Cement, steel, blocks, insulation and essential materials for construction projects.', image: '/images/sector-cards/building-materials-stores-card.webp', tagsAr: ['حديد', 'أسمنت', 'عزل'], tagsEn: ['Steel', 'Cement', 'Insulation'] },
  { slug: 'finishing-works', marketplace: true, titleAr: 'التشطيبات والديكور', titleEn: 'Finishing & Décor', eyebrowAr: 'منتجات ومتاجر', eyebrowEn: 'Products & stores', descAr: 'الرخام والسيراميك والدهانات والزجاج والألمنيوم ومنتجات التشطيب.', descEn: 'Marble, tiles, paints, glass, aluminium and finishing products.', image: '/images/sector-cards/aluminium-glass-wood-card.webp', tagsAr: ['رخام', 'سيراميك', 'دهانات'], tagsEn: ['Marble', 'Tiles', 'Paints'] },
  { slug: 'furniture-decor', marketplace: true, titleAr: 'الأثاث والتجهيزات', titleEn: 'Furniture & Interior Fittings', eyebrowAr: 'منتجات ومتاجر', eyebrowEn: 'Products & stores', descAr: 'الأثاث والمطابخ والنجارة والإضاءة والتجهيزات الداخلية للمشروع.', descEn: 'Furniture, kitchens, carpentry, lighting and interior fittings.', image: '/images/sector-cards/factories-suppliers-workshops-card.webp', tagsAr: ['أثاث', 'مطابخ', 'إضاءة'], tagsEn: ['Furniture', 'Kitchens', 'Lighting'] },
  { slug: 'smart-systems', marketplace: true, titleAr: 'المعدات والأنظمة', titleEn: 'Equipment & Systems', eyebrowAr: 'منتجات ومتاجر', eyebrowEn: 'Products & stores', descAr: 'المعدات والأدوات وأنظمة التكييف والكهرباء والسباكة والحلول الذكية.', descEn: 'Equipment, tools, AC, electrical, plumbing and smart-system solutions.', image: '/images/sector-cards/maintenance-finishing-ac-plumbing-electrical-card.webp', tagsAr: ['معدات', 'أنظمة ذكية', 'أدوات'], tagsEn: ['Equipment', 'Smart systems', 'Tools'] },
];
...
export default function UaeDirectorySectorCards({ emirate, locale = 'ar' }) {
  ...
  const hrefFor = (card) => card.marketplace
    ? `${isEn ? '/en' : ''}/marketplace/${card.slug}`
    : isEn ? `/en/uae/${emirate.slug}/${card.slug}` : `/uae/${emirate.slug}/${card.slug}`;
  ...
  return (
    <section dir={isEn ? 'ltr' : 'rtl'} id="uae-sector-cards" className="mx-auto max-w-6xl px-4 py-14 md:py-18">
      <div className={isEn ? 'mb-8 text-center md:text-left' : 'mb-8 text-center md:text-right'}>
        <span className="inline-flex rounded-full border border-[#B8922B]/30 bg-white px-4 py-1.5 text-xs font-black text-[#8A6A00] shadow-sm">{isAbuDhabi ? (isEn ? '11 service and product paths' : '11 مسارًا للخدمات والمنتجات') : (isEn ? '7 main sectors' : '7 قطاعات رئيسية')}</span>
        <h2 className="mt-4 text-3xl font-black text-[#0F3F1A] md:text-4xl">{isAbuDhabi ? (isEn ? 'Explore Abu Dhabi Services and Products' : 'استكشف خدمات ومنتجات أبوظبي') : (isEn ? `Choose the sector in ${emirateName}` : `اختر القطاع في ${emirateName}`)}</h2>
      </div>
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
        {cards.map((card, index) => {
          ...
          return <article key={`${card.marketplace ? 'marketplace' : 'directory'}-${card.slug}-${index}`} className="group overflow-hidden rounded-[2rem] border border-[#E6DCC8] bg-white shadow-[0_18px_45px_rgba(18,58,70,0.08)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_24px_60px_rgba(18,58,70,0.15)]">

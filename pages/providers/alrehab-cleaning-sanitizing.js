      ...
      <div dir="rtl" className="min-h-screen bg-[#F8F4EC] text-[#1D2E22]">
        ...
        <main>
          ...
          <section id="services" className="scroll-mt-28 border-y border-[#E6DCC8] bg-white/65 py-12 md:py-14">
            <div className="mx-auto max-w-6xl px-4">
              ...
              <p className="mt-4 max-w-3xl leading-8 text-[#625A50]">
                تعرض كل بطاقة خدمة نوع التنظيف ومعرفه وصورته المستقلة. اقرأ الملخص ثم اضغط «التفاصيل» لمعرفة الصور والعدد والمقاسات والمعلومات المطلوبة لتقييم الحالة وتجهيز عرض السعر.
              </p>
              ...
              <div className="mt-12 border-t border-[#E6DCC8] pt-10">
                ...
                <p className="mt-4 max-w-3xl leading-8 text-[#625A50]">
                  تبدأ كل باقة بمراجعة الصور والعدد والمقاسات وحالة البقع وموقع الخدمة، ثم يُعتمد السعر والموعد بوضوح قبل التنفيذ.
                </p>
          ...
          <section id="products" className="scroll-mt-28 mx-auto max-w-6xl px-4 py-14">
            ...
            <p className="mt-4 max-w-3xl leading-8 text-[#625A50]">
              هذا القسم مخصص للمنتجات والمواد التي يضيفها مزود الخدمة من لوحة الإدارة، مع صورة ومعرف ووصف وسعر أو طريقة تسعير واضحة لكل منتج.
            </p>

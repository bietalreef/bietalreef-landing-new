...
const visualSections = [
  {
    ...
    desc: 'نعرض رؤية بيت الريف بشكل واضح: موقع تعريفي للأرشفة والتسويق، وتطبيق للتشغيل والسوق والخرائط والطلبات، ووياك كمساعد ذكي داخل الرحلة.',
  ...
  },
  {
    ...
    desc: 'صفحات الموقع تشرح كيف يمكن للعميل رؤية الفكرة والتصميم والتكلفة قبل التنفيذ، مع ربط ذلك لاحقاً بالتطبيق وطلبات عروض الأسعار.',
    ...
    <>
      <section className="max-w-6xl mx-auto px-4 py-12 md:py-16" dir="rtl">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 max-w-3xl mx-auto leading-8">نحافظ على ترتيب الموقع الحالي ونضيف عليه صفحات واضحة للمدن، المناطق، التخصصات، مزودي الخدمات، السوق، ووياك، مع استخدام الصور الاحترافية الموجودة بالفعل داخل المشروع.</p>
        </div>

...
const PLATFORM_DESTINATIONS = Object.freeze({
  market: 'https://app.bietalreef.ae/',
  providersApp: 'https://providers.bietalreef.ae/',
  googlePlay: 'https://play.google.com/store/apps/details?id=ae.bietalreef.app',
});
...
const corePairs = [
  ...
  { ar: '/press', en: '/en/press', priority: 0.55, changefreq: 'monthly' },
  { ar: '/community', en: '/en/community', priority: 0.5, changefreq: 'monthly' },
  { ar: '/contractors-in-uae', en: '/en/contractors-in-uae', priority: 0.65, changefreq: 'monthly' },
  { ar: '/interior-design-uae', en: '/en/interior-design-uae', priority: 0.65, changefreq: 'monthly' },
  { ar: '/building-materials-uae', en: '/en/building-materials-uae', priority: 0.65, changefreq: 'monthly' },
  { ar: '/cleaning-uae', en: '/en/cleaning-uae', priority: 0.6, changefreq: 'monthly' },
  { ar: '/electrical-contractors-uae', en: '/en/electrical-contractors-uae', priority: 0.6, changefreq: 'monthly' },
  { ar: '/equipment-rental-uae', en: '/en/equipment-rental-uae', priority: 0.6, changefreq: 'monthly' },
  { ar: '/furniture-uae', en: '/en/furniture-uae', priority: 0.6, changefreq: 'monthly' },
  { ar: '/maintenance-uae', en: '/en/maintenance-uae', priority: 0.6, changefreq: 'monthly' },
  { ar: '/villa-renovation-uae', en: '/en/villa-renovation-uae', priority: 0.6, changefreq: 'monthly' },
];

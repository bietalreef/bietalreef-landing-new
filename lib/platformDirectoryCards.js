    ...
    return profiles
      ...
      .map((profile) => {
        ...
        return {
          id: profile.id,
          entityType: 'provider',
          name: isEn ? profile.name_en || profile.name_ar : profile.name_ar,
          providerType: providerTypeLabels[profile.provider_type] || profile.provider_type,
          city: isEn ? city?.name_en || city?.name_ar : city?.name_ar,
          area: isEn ? area?.name_en || area?.name_ar : area?.name_ar,
          specialties,
          verified: profile.verification_status === 'verified',
          coverImage: profile.cover_image_url || profile.logo_url,

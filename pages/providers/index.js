          ...
          <div className="bg-[#FDFBF7] rounded-[40px] border border-[#E6DCC8] p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              ...
              <div className="flex-1 grid grid-cols-2 gap-4">
                <div className="bg-white p-6 rounded-3xl border border-[#E6DCC8] text-center"><div className="text-3xl font-black text-[#0F3F1A] mb-1">قريبًا</div><div className="text-[10px] font-bold text-gray-400 uppercase">مزودون معتمدون</div></div>

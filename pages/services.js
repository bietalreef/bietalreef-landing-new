...
const servicesItemListSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 5, "name": "الورش الصناعية", "url": "https://bietalreef.ae/services/carpentry" },
        ...
        <main className="flex-1">
          <section className="bg-gradient-to-b from-primary via-primary-dark to-primary-dark text-white py-12 md:py-20">
            <div className="max-w-6xl mx-auto px-4 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white bg-opacity-20 text-white text-xs mb-6">
                <span>⚒️</span>
                <span>قسم مستقل للخدمات والعروض</span>
              </div>
              <h1 className="text-3xl md:text-5xl font-bold mb-4">الخدمات والعروض</h1>
              <p className="text-lg md:text-xl max-w-3xl mx-auto mb-2">
                اختر نوع الخدمة أولًا، ثم أرسل تفاصيل مشروعك للحصول على توجيه أو عرض سعر مناسب.
              </p>
              <p className="text-base md:text-lg max-w-3xl mx-auto opacity-90">
                هذا القسم مستقل عن دليل الإمارات. البحث حسب الموقع يبدأ من دليل الإمارات، أما هنا فالبداية من نوع الخدمة.
              </p>
            </div>
          </section>
                    ...
                    <div className="group bg-white rounded-xl shadow-md hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer h-full border border-gray-100 hover:border-primary">
                      <div className="h-40 bg-gradient-to-br from-blue-50 via-green-50 to-blue-50 flex items-center justify-center overflow-hidden relative border-b-2 border-gray-100">
                        <div className="relative w-32 h-32">
                          <Image src={service.icon} alt={service.title} fill className="object-contain p-2 group-hover:scale-125 transition-transform duration-500 drop-shadow-lg" />
                        </div>
                      ...
                      <div className="p-5">
                        ...
                        <div className="mb-4 pb-4 border-b border-gray-200">
                          <p className="text-xs text-gray-600 mb-1">طريقة التسعير:</p>
                          <p className="text-base font-bold text-primary bg-primary bg-opacity-10 px-3 py-2 rounded-lg inline-block">حسب تفاصيل المشروع</p>
                        </div>
          ...
          <section className="bg-gradient-to-b from-gray-50 to-white py-16 md:py-24">
            <div className="max-w-6xl mx-auto px-4">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">كيف تختار الخدمة المناسبة؟</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center p-6 rounded-xl bg-white shadow-soft"><div className="text-5xl mb-4">1️⃣</div><h3 className="font-bold text-lg mb-3">حدد الخدمة</h3><p className="text-gray-600 text-sm">ابدأ من نوع العمل المطلوب: مقاولات، صيانة، نجارة، رخام أو غيرها.</p></div>
                <div className="text-center p-6 rounded-xl bg-white shadow-soft"><div className="text-5xl mb-4">2️⃣</div><h3 className="font-bold text-lg mb-3">أضف التفاصيل</h3><p className="text-gray-600 text-sm">الموقع، المقاسات، الصور، والمواد المطلوبة تساعد على توجيه الطلب.</p></div>
                <div className="text-center p-6 rounded-xl bg-white shadow-soft"><div className="text-5xl mb-4">3️⃣</div><h3 className="font-bold text-lg mb-3">اطلب عرض سعر</h3><p className="text-gray-600 text-sm">لا نعتمد على سعر عام؛ السعر الصحيح يحتاج تفاصيل المشروع.</p></div>
              </div>
            </div>
          </section>
        </main>

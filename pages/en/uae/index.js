          ...
          <section id="uae-emirates" className="scroll-mt-24 px-4 py-10 md:py-14">
            <div className="mx-auto max-w-6xl">
              ...
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                {UAE_EMIRATES.map((emirate, index) => <Link key={emirate.slug} href={`/en/uae/${emirate.slug}`} className="group block overflow-hidden rounded-[2.15rem] border border-[#E4D6BA] bg-white/95 p-2 shadow-xl shadow-black/5 transition hover:-translate-y-1 hover:border-[#D4AF37]/70">

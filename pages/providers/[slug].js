  ...
  return (
    <>
      ...
      <div dir="rtl" className="min-h-screen bg-[#FDFBF7] text-gray-900">
        <Navbar />
        <main>
          <section className="relative overflow-hidden bg-[radial-gradient(circle_at_top_left,#FFF8EA_0%,#EFE3CC_42%,#CDBB98_100%)] text-[#102515]">
            <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(255,255,255,0.72)_0%,rgba(247,241,228,0.82)_42%,rgba(205,187,152,0.56)_100%)]" />
            {provider.cover && <div className="absolute inset-0"><Image src={provider.cover} alt={provider.nameAr} fill className="object-cover opacity-18 mix-blend-multiply" priority /></div>}
            <div className="relative mx-auto max-w-6xl px-4 pt-7 pb-12 md:pt-9 md:pb-16">
              <Link href="/providers" className="inline-flex items-center gap-2 rounded-full border border-[#B8922B]/35 bg-white/55 px-4 py-2 text-sm font-black text-[#0F3F1A] shadow-sm backdrop-blur hover:bg-white transition">
              ...
              <div className="mt-8 grid gap-10 lg:grid-cols-[1.35fr_0.85fr] lg:items-center">
                <div>
                  <div className="mb-5 flex flex-wrap gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-full border border-[#B8922B]/40 bg-[#FFF8E5]/80 px-4 py-1.5 text-xs font-black text-[#8A6A00]"><Gem className="h-3.5 w-3.5" /> تخصص فاخر</span>
                    ...
                    <span className="rounded-full bg-white/65 px-4 py-1.5 text-xs font-black text-[#0F3F1A]">{provider.providerTypeAr}</span>
                  </div>

                  <h1 className="text-4xl font-black leading-tight md:text-6xl text-[#0F3F1A]">{provider.nameAr}</h1>
                  ...
                  <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                    ...
                    {whatsappDigits && <a href={`https://wa.me/${whatsappDigits}?text=${encodeURIComponent('مرحباً، أرغب في الاستفسار عن خدمات مصنع الحوت الأبيض عبر بيت الريف')}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 rounded-2xl border border-[#B8922B]/35 bg-white/55 px-8 py-4 font-black text-[#0F3F1A] backdrop-blur transition hover:bg-white">واتساب مباشر <ExternalLink className="h-4 w-4" /></a>}
                    <a href={`tel:${provider.phone}`} className="inline-flex items-center justify-center gap-2 rounded-2xl border border-[#B8922B]/35 bg-white/35 px-8 py-4 font-black text-[#8A6A00] transition hover:bg-white"><Phone className="h-5 w-5" /> اتصل الآن</a>
                  </div>
                </div>
                ...
                <div className="rounded-[2rem] border border-[#B8922B]/30 bg-white/45 p-6 shadow-2xl shadow-[#8A6A00]/10 backdrop-blur">
                  <div className="rounded-[1.5rem] bg-gradient-to-br from-white/85 via-[#FFF8E5]/75 to-[#E6D8BD]/70 p-6">
                    ...
                    <div className="mt-4 flex items-center gap-2 rounded-xl bg-white/70 px-4 py-3"><CheckCircle2 className="h-4 w-4 text-emerald-600" /><span className="text-xs font-bold text-[#0F3F1A]">بيانات مزود خدمة ضمن منصة بيت الريف</span></div>
                  </div>
                </div>
              </div>
            </div>

...
const description = 'Shipping and returns policy for Arkleen Carpentry and Interior Design products in Al Ain, covering delivery timing, ready-made products and custom-made products.';
...
export default function ArkleenShippingReturnsEnglishPage() {
  return (
    <EnglishGenericPage
      ...
      intent="Arkleen delivers confirmed orders within 3 business days after the product is ready, with free delivery inside Al Ain. A ready-made product may be returned within 10 days of receipt if it is unused, in its original condition and accompanied by proof of purchase. Products manufactured or modified to a customer’s specifications cannot be returned once production has started, except when there is a manufacturing defect or the product does not match the agreed specifications."
      points={[
        'Delivery takes 3 business days after product readiness is confirmed, and delivery is free within Al Ain.',
      ...
      faqs={[
        ['How long does Arkleen delivery take?', 'The stated delivery time is 3 business days after the product is confirmed ready. Delivery within Al Ain is free.'],
